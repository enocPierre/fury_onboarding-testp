 ...
 * @see Configuration
 */
@ComponentScan("com.mercadolibre.onboarding_testp")
@Configuration
...
public class SpringConfig implements WebMvcConfigurer {
  ...
  /**
   * Returns a filter that enables traceability in sync instructions.
   * It must be configured as the first filter of the application.
  ...
  /**
   * Creates a module to register in object mapper for serialization/deserialization.
